...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-20 overflow-hidden bg-white">
      ...
      {/* Hero Content Container - Narrow for optimal text readability */}
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row gap-5 w-full md:w-auto animate-fade-in-up mb-16" style={{ animationDelay: '0.3s' }}>
          <button
            ...
            className="bg-neutral-900 text-white px-8 py-4 rounded-full text-lg font-medium hover:bg-black hover:scale-105 transition-all duration-300 shadow-xl shadow-neutral-900/20 active:scale-95"
          >
            Get Early Access
          </button>
        </div>
      ...
      {/* Feature Carousel Container - Wide for immersive video display */}
      <div className="relative z-10 w-full animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
        <FeatureCarousel />
      </div>
